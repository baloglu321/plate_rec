...
if "processor_1" not in st.session_state:
    st.session_state.processor_1 = VideoProcessor.get_instance(
        "processor_1", "./video.mp4", fps=20.0
    )

if "processor_2" not in st.session_state:
    st.session_state.processor_2 = VideoProcessor.get_instance(
        "processor_2", "./video-2.mp4", fps=15.0
    )
